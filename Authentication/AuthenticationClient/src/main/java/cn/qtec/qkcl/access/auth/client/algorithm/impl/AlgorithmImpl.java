package cn.qtec.qkcl.access.auth.client.algorithm.impl;

import cn.qtec.qkcl.access.auth.client.algorithm.IAlgorithm;
...
public class AlgorithmImpl implements IAlgorithm {
    ...
    @Override
    public byte[] getPbkdf2SHA256(byte[] passwordBytes, byte[] salt, int iterationCount) {
