package cn.qtec.qkcl.access.auth.server.security.impl;

import cn.qtec.qkcl.access.auth.server.security.ISecurity;
...
public class SecurityImpl implements ISecurity {
   ...
   /* @Override
    public byte[] encrypt(byte[] data) throws Exception {
        Cipher encryptCipher = getCipher(Cipher.ENCRYPT_MODE, secretKey.getBytes());
        return encryptCipher.doFinal(data);
    }*/
   ...
   /* @Override
    public byte[] decrypt(byte[] encryptedData) throws Exception {
        Cipher decryptCipher = getCipher(Cipher.DECRYPT_MODE, secretKey.getBytes());
        return decryptCipher.doFinal(encryptedData);
    }*/
